...
class _CheckoutScreenState extends ConsumerState<CheckoutScreen> {
  ...
  void _onPayNow() async {
    ...
    if (mounted) {
      ...
      final shipping = ref.read(checkoutProvider.notifier).getShippingCost();
      await ref
          .read(orderHistoryProvider.notifier)
          .addOrder(subtotal + shipping, ref.read(cartProvider));
  ...
  Widget build(BuildContext context) {
    ...
    final deliveryMethod = checkoutState.deliveryMethod;

    final isReady = address != null && paymentMethod != null;
    final subtotal = ref.watch(cartTotalProvider);
    final shipping = ref.watch(checkoutProvider.notifier).getShippingCost();
        ...
        children: [
          ...
          Align(
            ...
            child: Container(
              ...
              decoration: const BoxDecoration(color: const Color(0xFFF6F7F9)),
              child: SizedBox(
  ...
  Widget _buildDeliveryOption(
    ...
    return GestureDetector(
      onTap: () => ref.read(checkoutProvider.notifier).setDeliveryMethod(title),
